    ...
    <>
     {/* <main className=""> */}
      ...
      <section className="bg-[#aac400] bg-blend-multiply">
        ...
        <div className="container mx-auto grid grid-cols-2 pt-10">
      ...
      <footer className="bg-[#0d1c28] shadow dark:bg-gray-900">
        <div className="container mx-auto pt-10">
          ...
          <div className="flex flex-row sm:justify-center col-start-2 col-span-4">
            <p className="justify-center col-start-2 col-span-4">
