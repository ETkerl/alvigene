    ...
    <>
     {/* <main className=""> */}
      ...
      <section className="bg-[#aac400] bg-blend-multiply">
        ...
        <div className="md:container md:mx-auto md:grid md:grid-cols-2 pt-8">
          <div className="py-20 ">
            <h1 className="text-6xl">Donnez à votre peau <br />
            ...
            <div className="py-7">
              <a href="#products" className="">
                <button type="button" className="focus:outline-none text-white bg-green-600 font-medium text-xl px-5 py-2.5 me-2 mb-2">
                  Voir nos produits
                </button>
              </a>
            </div>
